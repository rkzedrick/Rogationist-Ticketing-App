...
const ProfileScreen = () => {
    ...
    try {
      ...
      const endpoint =
        storedUserType === 'employee'
          ? `http://192.168.1.140:8080/EmployeeService/employee/${userId}`
          : `http://192.168.1.140:8080/StudentService/student/${userId}`;
  ...
  const saveProfileData = async (updatedProfile) => {
    ...
    try {
      ...
      const endpoint =
        userType === 'employee'
          ? `http://192.168.1.140:8080/EmployeeService/employee/update/${userId}`
          : `http://192.168.1.140:8080/StudentService/student/update/${userId}`;
